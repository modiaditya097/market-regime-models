...
def model_tab_ui(cfg: dict):
    return ui.page_fluid(
        ui.div(
            ...
            ui.p("S&P 500 Regime Detection using Returns-based HMM", class_="lead"),
            ui.hr(),
            ...
            ui.layout_columns(
                ui.card(
                    ...
                    ui.markdown("""
                    **Approach:** Hidden Markov Model with 3 states
                    
                    **Features:** Lagged returns
                    
                    **States:** Bull, Neutral, Bear markets
                    
                    **Parameters:** ~15 estimated parameters
