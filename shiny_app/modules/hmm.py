...
def model_tab_ui(cfg: dict):
    return ui.page_fluid(
        ui.div(
            ui.h2("HMM: 5-State Hidden Markov Model", class_="text-primary"),
            ui.p("S&P 500 Multi-Feature Regime Detection", class_="lead"),
            ui.hr(),
            ...
            ui.layout_columns(
                ui.card(
                    ...
                    ui.markdown("""
                    **Approach:** Hidden Markov Model with 5 states
                    
                    **Features:** Returns, volatility, volume, momentum
                    
                    **States:** 5 distinct market regimes
                    
                    **Parameters:** ~50 estimated parameters
