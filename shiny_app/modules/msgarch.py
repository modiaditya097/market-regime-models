...
def model_tab_ui(cfg: dict):
    return ui.page_fluid(
        ui.div(
            ui.h2("MS-GARCH: Markov-Switching GARCH Model", class_="text-primary"),
            ui.p("S&P 500 Regime Detection with Volatility-Based Switching", class_="lead"),
            ui.hr(),
            ...
            ui.layout_columns(
                ui.card(
                    ...
                    ui.markdown("""
                    **Approach:** Markov-Switching GARCH
                    
                    **Features:** Volatility terciles for regime classification
                    
                    **States:** High, Medium, Low volatility regimes
                    
                    **Parameters:** GARCH(1,1) with regime switching
